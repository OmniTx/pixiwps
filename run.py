...
print('''
\033[1;34m WPS Attack using PIXIDUST
Github: https://github.com/omnitx
One line Command:\nsudo python pixiwps/run.py -i wlan0 -K\n
For Help Type:\npython pixiwps/run.py --help\033[0m
''')
...
class Companion:
    ...
    def __init__(self, interface, save_result=False, print_debug=False):
        ...
        self.sessions_dir = f'{user_home}/.OmniTx/sessions/'
        self.pixiewps_dir = f'{user_home}/.OmniTx/pixiewps/'
